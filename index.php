...
<div class="well" style="width:600px; height: 400px ; margin:0px auto;">
    <form class="form-horizontal" method="post" action="reg_submit.php" aligm="middle" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label">SELECT PROFILE PIC:</label>
            <div class="col-md-6">
